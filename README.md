...
## :pushpin: **2. Dự án thể hiện các kỹ năng phân tích dữ liệu trọng tâm:**
...
* Dữ liệu Nhóm Tài sản tích trữ (Vàng, Bạc): được trích xuất từ nền tảng tài chính uy tín hàng đầu thế giới. Websitetruy cập: [Investing](investing.com)
...
* 
#### 4. Trực quan hóa xu hướng bằng Power BI
* Xây dựng mô hình dữ liệu (Model View) và thiết lập các bộ lọc (Slicers) giúp người dùng tương tác linh hoạt theo thời gian 
  
![Mô tả ảnh](https://drive.google.com/uc?export=view&id=1XVhOD6SrzxsBot-g7H5Dfdte2KSJVdKL)
* Ứng dụng các hàm DAX để tính toán các chỉ số nâng cao như chênh lệch giá lợn sống/bán lẻ và biên độ dao động trung bình của từng ngành hàng
* Thiết kế các biểu đồ chuyên biệt: Waterfall Chart để theo dõi sự tích lũy giá trị của Vàng/Bạc, Area Chart cho vùng biến động giá xăng, và các KPI Cards hiển thị đỉnh giá lịch sử.
