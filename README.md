...
Dự án được triển khai nhằm bóc tách bản chất của từng nhóm mặt hàng. Tiến hành tìm kiếm thu thập dữ liệu lịch sử trong giai đoạn 20 năm (2005 – 2025) từ nhiều nguồn uy tín. Phân loại 7 mặt hàng vào 3 nhóm chính: Lương thực - Thực phẩm, Đi lại - Sinh hoạt và Tài sản tích trữ dễ dàng so sánh biên độ biến động giữa nhóm tiêu dùng thiết yếu và nhóm đầu tư

> :file_folder: **Quản lý dữ liệu:** Toàn bộ dữ liệu và file tài liệu giải thích chi tiết về quy trình xử lý (Data Dictionary & ETL Process) được lưu trữ tập trung tại thư mục **[data](./data/)**.
...
* **Chi tiết quy trình ETL xem tại:** [Tài liệu thư mục Data](./data/)
...
:books: **Xem chi tiết phân tích chuyên sâu và Data Storytelling cho từng Dashboard tại đây:** [Thư mục Visualisation](./visualisation/)
...
* **Tài liệu Dữ liệu & Quy trình ETL:** [Chi tiết tại thư mục /data/](./data/) Chứa bộ từ điển dữ liệu, nguồn gốc và các công thức xử lý từ Excel sang Power BI.
